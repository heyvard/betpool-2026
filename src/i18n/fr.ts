...
const fr: Translations = {
    ...
    grupper: {
        tittel: 'Groupes',
        tom: 'Les classements des groupes seront remplis dès le début des matchs.',
        lag: 'Équipe',
        spilte: 'J',
        seier: 'G',
        uavgjort: 'N',
    ...
    allesTips: {
        tilbake: 'Accueil',
        undertittel: 'Tous les pronostics · {{liga}}',
        liganavn: 'Ligue principale',
        toggleVinner: 'Vainqueur',
        toggleToppscorer: 'Meilleur buteur',
        statHarValgt: 'Ont choisi',
        statMestValgt: 'Plus choisi',
        statUlikeTips: 'Choix différents',
        dittTips: 'Ton pronostic',
        rangering: '{{n}}ᵉ pronostic le plus choisi',
        alene: 'Tu es seul·e sur ce pronostic',
        delerMedEn: 'Tu le partages avec 1 autre',
        delerMedAndre: 'Tu le partages avec {{n}} autres',
        muligBonus: 'Bonus possible',
        poeng: 'points',
        ingenValgTittel: "Tu n'as pas encore parié",
        ingenValgTekst: "Choisis le vainqueur et le meilleur buteur sur la page d'accueil.",
        ingenValgLenke: 'Parier maintenant →',
        avTotalt: '{{antall}} sur {{totalt}}',
        deg: 'TOI',
        tomLiga: "Personne dans la ligue n'a encore parié.",
        bunntekst:
    ...
    spilteKamper: {
        ...
        uavgjort: 'Nul',
        fasit: 'Résultat',
        poengBeregnesNaarFerdig: 'Les points seront calculés à la fin du match.',
        sorterPoeng: 'Points',
        sorterNavn: 'Nom',
        sorterTippetSkor: 'Score parié',
        venter: 'En attente',
        liggerAnTil: 'En passe de {{status}}',
        tipsAntall: '{{antall}} paris',
        traffResultat: '{{antall}} ont le bon score',
        traffUtfall: '{{antall}} ont le bon résultat',
        ordinaerTidTippes: 'Temps réglementaire · Pronostiqué',
        videre: 'Qualifié',
        faseEkstraomganger: 'Prolongations',
        faseStraffer: 'Tirs au but',
        avgjortStraffer: 'aux tirs au but',
        avgjortEkstraomg: 'en prolongation',
        fasitForTipping: 'Résultat retenu',
        gikkVidereNote: '{{lag}} s’est qualifié {{hvordan}}, sans incidence sur les points.',
        poengRegnesOrdinaerTid: 'Les points sont calculés sur le temps réglementaire.',
    ...
    historikk: {
        tittel: 'Historique du classement',
        seUtvikling: "Voir l'évolution",
        plasseringsgraf: 'graphique du classement',
        plasseringOverTid: 'Classement dans le temps',
        bedre: 'Mieux',
        folg: 'Suivez {{navn}} au classement',
        markerSpiller: 'Choisir un joueur',
        finnDeltaker: 'Trouver un participant…',
        idag: "Aujourd'hui",
        kampdag: 'Journée {{n}}',
        tomIngenKamper: "L'historique commence après la première journée.",
        merKommer: "Plus d'historique après la prochaine journée.",
        ikkeTilgjengelig: 'Disponible après la première journée',
    },
    regler: {
        tittel: 'Règles',
        innskuddTittel: 'Mise',
    ...
    ligaer: {
        ...
        inviterPersoner: 'Ajouter des participants',
        inviterPersonerBeskrivelse: 'Optionnel. Vous pouvez aussi ajouter des personnes via un lien après la création.',
